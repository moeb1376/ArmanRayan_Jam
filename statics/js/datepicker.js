(function($) {
  ...
  let _defaults = {
    ...
    defaultDate: new Date(Date.UTC(1380, 8, 20, 0, 0, 0)),
    ...
    i18n: {
      ...
      weekdays: ['شنبه', 'یکشنه', 'دوشنبه', 'سه شنبه', 'چهارشنبه', 'پنجشنبه', 'جمعه'],
      weekdaysShort: ['شنبه', 'یکشنبه', 'دوشنبه', 'سه شنبه', 'چهارشنبه', 'پنجشنبه', 'جمعه'],
      weekdaysAbbrev: ['ش', 'ی', 'د', 'س', 'چ', 'پ', 'ج']
    },
